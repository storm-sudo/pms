...
// Admin co-founders & Sys Admin
export const admins: User[] = [
  {
    id: 'sys-admin',
    name: 'Sys Admin',
    email: 'adminnt@gmail.com',
    password: 'Synapse@Admin2026!',
    role: 'admin',
    department: 'Leadership',
    skills: ['Management', 'Strategy', 'Clinical Governance'],
...
export const members: User[] = [
  ...
  },
  {
    ...
    password: 'Sayali$MB2026',
    role: 'member',
    department: 'Mol Bio',
    skills: ['PCR', 'NGS', 'Gel Electrophoresis', 'LabSafety'],
    weeklyCapacityHours: 40,
    avatar: '',
    status: 'approved',
    workload: { activeTasks: 0, completedThisWeek: 0, overdueTasks: 0, avgCompletionTime: 0 },
  ...
  },
  {
    ...
    password: 'Aruna$BI2026',
    role: 'member',
    department: 'Bioinfo',
    skills: ['Python', 'Biopython', 'Genomics', 'Sequence Analysis'],
    weeklyCapacityHours: 40,
    avatar: '',
    status: 'approved',
    workload: { activeTasks: 0, completedThisWeek: 0, overdueTasks: 0, avgCompletionTime: 0 },
