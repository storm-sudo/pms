...
export const projects: Project[] = [
  {
    ...
    elnLinks: [
      { userId: 'u4', urls: ['https://eln.nucleovir.com/priya/aav-opt'] },
      { userId: 'u5', urls: ['https://eln.nucleovir.com/raj/aav-vectors'] },
    ],
    comments: [
  ...
  },
  {
    ...
    elnLinks: [
      { userId: 'u10', urls: ['https://eln.nucleovir.com/kavitha/ml-targets'] },
      { userId: 'u11', urls: ['https://eln.nucleovir.com/arun/prediction-models'] },
    ],
    comments: [],
    milestones: [
  ...
  },
  {
    ...
    elnLinks: [
      { userId: 'u16', urls: ['https://eln.nucleovir.com/amit/variant-pipeline'] },
    ],
    comments: [
  ...
  },
  {
    ...
    memberIds: ['u8', 'u9'],
    elnLinks: [
      { userId: 'u8', urls: ['https://eln.nucleovir.com/meera/crispr-screens'] },
    ],
    comments: [],
    milestones: [
  ...
  },
  {
    ...
    memberIds: ['u19', 'u20'],
    elnLinks: [
      { userId: 'u19', urls: ['https://eln.nucleovir.com/pooja/clinical-data'] },
      { userId: 'u20', urls: ['https://eln.nucleovir.com/venkat/data-integration'] },
    ],
    comments: [],
    milestones: [
...
export const tasks: Task[] = [
  // AAV Vector Optimization tasks
  {
    ...
    subtasks: [
      { id: 's1', title: 'Literature search', completed: true, assigneeIds: [] },
      { id: 's2', title: 'Variant selection', completed: true, assigneeIds: [] },
      { id: 's3', title: 'Sequence design', completed: true, assigneeIds: [] },
    ],
    comments: [],
    tags: ['design', 'capsid'],
    progress: 100,
  ...
  },
  {
    ...
    startDate: daysAgo(7),
    subtasks: [
      { id: 's4', title: 'PCR amplification', completed: true, assigneeIds: [] },
      { id: 's5', title: 'Restriction digest', completed: true, assigneeIds: [] },
      { id: 's6', title: 'Ligation & transformation', completed: false, assigneeIds: ['u5'] },
      { id: 's7', title: 'Colony screening', completed: false, assigneeIds: ['u5'] },
    ],
    comments: [],
  ...
  },
  {
    ...
    subtasks: [
      { id: 's8', title: 'Cell culture prep', completed: true, assigneeIds: [] },
      { id: 's9', title: 'Transduction', completed: false, assigneeIds: [] },
      { id: 's10', title: 'Flow cytometry analysis', completed: false, assigneeIds: [] },
    ],
    comments: [
  ...
  },
  {
    ...
    startDate: daysAgo(5),
    subtasks: [
      { id: 's11', title: 'Sequence embeddings', completed: true, assigneeIds: [] },
      { id: 's12', title: 'Structural features', completed: false, assigneeIds: ['u11'] },
      { id: 's13', title: 'Interaction networks', completed: false, assigneeIds: ['u12'] },
    ],
    comments: [],
    tags: ['ml', 'features'],
    order: 2,
  ...
  // Variant Calling Pipeline tasks
  {
    ...
    startDate: daysAgo(21),
    subtasks: [
      { id: 's14', title: 'Read alignment', completed: true, assigneeIds: [] },
      { id: 's15', title: 'Variant detection', completed: true, assigneeIds: [] },
      { id: 's16', title: 'Filtering & annotation', completed: false, assigneeIds: [] },
    ],
    comments: [
  ...
  },
  {
    ...
    startDate: daysAgo(5),
    subtasks: [
      { id: 's17', title: 'Clone individual guides', completed: true, assigneeIds: [] },
      { id: 's18', title: 'Generate KO cells', completed: false, assigneeIds: [] },
      { id: 's19', title: 'Phenotype analysis', completed: false, assigneeIds: [] },
    ],
    comments: [],
  ...
  },
  {
    ...
    startDate: daysAgo(3),
    subtasks: [
      { id: 's20', title: 'Wireframes', completed: true, assigneeIds: [] },
      { id: 's21', title: 'Visual design', completed: false, assigneeIds: [] },
      { id: 's22', title: 'Prototype', completed: false, assigneeIds: [] },
    ],
    comments: [],
    tags: ['design', 'ui'],
    order: 3,
